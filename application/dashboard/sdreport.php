...
<html lang="en">
    <head>
        <title>Dashboard | Single Day Report</title>
    ...
    <body>
        ...
        <header class="dds-header-menu">
            <ul>                
                ...
                <li class="ddr-dash-single-day-report ddr-highlight">Single Day Report</li>
        ...
        <div class="ddr-form">
            <input type="text" size="25" class="ddr-exp-single-date" readonly="readonly" placeholder="Select Date" />&nbsp;&nbsp;<input type="button" value="Generate" class="ddr-single-day-rpt-btn" /><br/><br/>
